...
namespace DAFW_IS220.Areas_Files_Controllers_
{
    [Area("Files")]
    ...
    public class FileManagerController : Controller
    {
        ...
        private Connector GetConnector()
        {
            ...
            string absoluteUrl = Microsoft.AspNetCore.Http.Extensions.UriHelper.BuildAbsolute(Request.Scheme, Request.Host);
